...
export default async function ErrorsRedirectPage() {
  ...
  if (!isActiveProjectValid) {
    ...
    activeProjectId = firstProj.id;
  }

  // Redirect to the dynamic project errors page
  redirect(`/dashboard/${activeProjectId}/errors`);
}
